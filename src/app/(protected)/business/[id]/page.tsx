...
import { query, orderBy, limit, collection, where, getDocs, doc, getDoc } from "firebase/firestore";
...
export default async function Profile({params}: {params: {id: string}}) {
    ...
    const q = query(jobRef, where('by', '==', params.id)); 
    ...
    const employerRef = doc(db, 'profile', params.id);
    const res = (await getDoc(employerRef)).data()
                ...
                <div className="p-3 w-full">
                    ...
                    <div className="flex gap-2 items-center p-3 z-10 isolate">
                        ...
                        <div className="flex gap-1 flex-col">
                            ...
                            <span className="text-lg text-muted-foreground block font-normal">{res?.email}</span>
                    ...
                    <div className="">
                        <p className="flex bg-muted/30 py-2 border border-muted/40 px-3 my-2 rounded-sm hover:bg-muted/40 min-w-[300px] max-w-[420px]">
                            ...
                            <span className="grow">{res?.location}</span>
                        </p>
                    </div>
